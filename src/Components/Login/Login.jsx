            ...
            <div className='flex justify-center items-center w-full mt-20' >
                <div className='w-[400px] bg-slate-100 rounded-md'>
                    ...
                    <form onSubmit={hendleLogin} className="max-w-sm mx-auto">
                        ...
                        <span >You have no account? Please <Link className='text-blue-500 underline' to='/register'>Register</Link></span>

                        <div className="form-control my-6">
                            <button className="py-2 px-5 rounded-lg text-white bg-blue-600">Login</button> 
